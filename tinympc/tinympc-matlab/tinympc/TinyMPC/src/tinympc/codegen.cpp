...
#define BUF_SIZE 65536
                     ...
                     const char *tinympc_dir, const char *output_dir)
    {
        ...
        if (stat(workspace_dname, &st) == -1)
        {
            ...
            _mkdir(workspace_dname);         // workspace/
            _mkdir(workspace_src_dname);     // workspace/src
            _mkdir(workspace_tinympc_dname); // workspace/tinympc
            _mkdir(workspace_include_dname); // workspace/include
        }
